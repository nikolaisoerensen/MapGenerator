...
class DataLODManager(QObject):
    ...
    def __init__(self, memory_threshold_mb: int = 500):
        ...
        # managers/calculator_graph.py CALCULATOR_GRAPH), nicht nur die finalen
        ...
        # managers/calculator_graph.py). Der Orchestrator setzt ihn vor
    ...
    def set_calculator_output(self, calculator_id: str, lod_level: int, outputs: Dict[str, Any]):
        ...
        managers/calculator_graph.py CALCULATOR_GRAPH) für ein LOD-Level.
        Parameter:
