...
Drei Tests:
  ...
  A) Slope-Area-Gesetz   Hangneigung ~ Einzugsgebiet^beta. Zielkorridor
                         -0.4 .. -0.7 aus docs/SPEZIFIKATION.md §3.2 (dort
...
def run_slope_area_law_matches_target_corridor():
    ...
    diesem Test, sondern aus docs/SPEZIFIKATION.md §3.2 - dort unabhaengig als
    ...
    return check(
        ...
        "(docs/SPEZIFIKATION.md Paragraph 3.2, gemessen {:.3f})".format(beta),
        -0.7 <= beta <= -0.4)
