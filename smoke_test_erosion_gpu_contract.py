"""
Path: smoke_test_erosion_gpu_contract.py
...
Aufruf: .venv\\Scripts\\python.exe smoke_test_erosion_gpu_contract.py
"""
...
DISPATCHER = os.path.join(PROJECT, "gui", "OldManagers", "shader_manager.py")
...
def run_uniform_types_match():
    ...
    """
    from gui.OldManagers.shader_manager import _INT_UNIFORM_NAMES
