...
class WeatherSystemGenerator:
    ...
    def _calc_temperature(self, calculator_id: str, lod_level: int) -> None:
        ...
        try:
            ...
            # WIND IST SEIT 2026-08-11 REGIONAL KALIBRIERT (docs/spezifikation/10_REGIONEN.md
            # B.5), zwei multiplikative Faktorfelder statt einer eigenen
    ...
    # Luv/Lee-Kontrast am Gebirge fuer Wind (docs/spezifikation/10_REGIONEN.md B.5): "1.5-2x -
    ...
    def _wind_regional_faktor(self, wind_map: np.ndarray, lod_level: int) -> Optional[np.ndarray]:
        ...
        (docs/spezifikation/10_REGIONEN.md B.5, core/terrain_weltkarte.py REGIONEN.
