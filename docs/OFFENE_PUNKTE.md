...
* [x] **ERLEDIGT 2026-08-24.** Fjordland-Fairness 0.72 -> 0.64 -> **0.80** (`smoke_test_regionen_fairness`,
  ...
  **Zu entscheiden:** entweder der Zielwert fuer eine Fjordlandschaft ist
  zu hoch (der Nutzer hat fuer das Alpenland selbst 0.80 gesetzt - eine
...
`KUESTEN_SCHNITT_AKTIV`). Modellbeschreibung: `docs/KUESTENMODELL.md`.*
...
| [ ] | 3b.7 | **Schmale Landzungen bleiben schwach.** Im Inseltest ist `arme_3km` der schlechteste Fall: bei 288 m groesstem Kuestenabstand ist jeder Punkt Kuestenband, das Basisgelaende kommt nie durch. Loesung waere eine Tiefenklasse im Katalog (docs/KUESTENMODELL.md §3) - Abschnitte mit wenig Hinterland bekommen Typen mit kurzer Reichweite. | 2 |
...
Bereich (Mittelmeer, Griechische Inseln, Atlantikkueste).
...
**Sichtgeprueft** (drei Seeds nebeneinander gerendert und angesehen, nicht nur Kennzahlen): Halbinseln bleiben als Einheit zusammen — beim Beispielseed liegen die Nord-, West- und Suedhalbinsel jeweils vollstaendig in einer Karte, genau wie in der Nutzerskizze. Inselgruppen (Griechische Inseln) bleiben naturgemaess zerstueckelt; das ist die Welt, nicht der Schnitt.
