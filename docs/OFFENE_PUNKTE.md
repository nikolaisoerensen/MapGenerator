...
| **[x]** | **10.6** | Erosionskette `EROSION_AKTIV` — *Nutzer 2026-08-06: "vorerst nein"*, dann **doch eingeschaltet am 27.08.2026** (`gui/config/value_default.py:1088`, `True`). Die Zeile stand bis zum 16.09.2026 offen und behauptete damit weiter, die Kette sei aus. Sie ist an: vier Erosionstests sind rot, ihre Ursache ist ungeklaert (`docs/TESTBERICHT.md`, Abschnitt 3), und der Paritaetsbruch Faktor 385 zwischen GPU und CPU steht damit mitten im laufenden Betrieb statt vor einer Reaktivierung. | — |
