...
Aufruf:
    .venv\\Scripts\\python.exe scratch_weather_lab.py bilanz
    .venv\\Scripts\\python.exe scratch_weather_lab.py konvergenz
"""
...
OUTPUT_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "weather_lab")
...
def run_pipeline(map_size=128, map_distance_km=15.0, feedback_passes=None,
    ...
    from gui.OldManagers.calculator_graph import CalculatorDispatcher
...
def climate_sweep(map_size=128, breiten=(0, 10, 20, 30, 40, 50, 60), flach=True):
    """
