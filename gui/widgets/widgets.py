...
class StatusIndicator(QWidget):
    ...
    def setup_ui(self):
        ...
        self.status_text.setSizePolicy(QSizePolicy.Policy.Ignored, QSizePolicy.Policy.Preferred)
    ...
    def _set_status_text(self, full_text: str):
        ...
        elided = metrics.elidedText(full_text, Qt.TextElideMode.ElideRight, self._STATUS_TEXT_WIDTH)
