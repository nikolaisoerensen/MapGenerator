...
Aufruf:
    .venv\\Scripts\\python.exe tools/erosion_lab.py            # Standard-Sweep
    .venv\\Scripts\\python.exe tools/erosion_lab.py baseline   # nur Referenz
"""
